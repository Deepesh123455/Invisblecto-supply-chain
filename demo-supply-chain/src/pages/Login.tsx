          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1 font-body">
                {isLogin ? "Enter your credentials to access DemandIQ" : "Join businesses optimizing their supply chain"}
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3">
              {!isLogin && (
                ...
                >
                  <Input
                    ...
                    className="h-11 rounded-lg bg-secondary/50 border-border font-body"
                  />
                </motion.div>
              )}
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-11 rounded-lg bg-secondary/50 border-border font-body"
                />
              </div>
              <div className="relative">
